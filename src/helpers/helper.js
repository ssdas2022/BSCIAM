const mapABC = new Map([
    ...
    ['X', 59], ['Y', 60], ['Z', 61], ['@', 62], ['.', 63], ['1', 64], ['2', 65],
    ['3', 66], ['4', 67], ['5', 68], ['6', 69], ['7', 70], ['8', 71], ['9', 72],
    ['0', 73], ['-', 74], ['_', 75] 
]);
...
const map123 = new Map([
    ...
    [59, 'X'], [60, 'Y'], [61, 'Z'], [62, '@'], [63, '.'], [64, '1'], [65, '2'],
    [66, '3'], [67, '4'], [68, '5'], [69, '6'], [70, '7'], [71, '8'], [72, '9'],
    [73, '0'], [74, '-'], [75, '_']
]);

export const getNumKey = (key) => {
    var reskey = "";
    for (var i = 0; i < key.length; i++) {
        var num = mapABC.get(key[i]);
        reskey = reskey + num;
    }
    return reskey;
}

function pair(char1, char2) {
    return char1 + char2;
}

export const getCharKey = (key) => {
    var charKey = "";
    for (var i = 0; i < key.length; i += 2) {
        var num = pair(key[i], key[i + 1]);
        var chr = map123.get(parseInt(num));
        charKey = charKey + chr;
    }
    return charKey;
}